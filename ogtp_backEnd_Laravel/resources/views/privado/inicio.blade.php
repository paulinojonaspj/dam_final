...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <h5 class="card-header"><b>Actividades</b></h5>
                ...
                <thead>
                    <tr>
                        <th><a class="btn btn-info" style="padding: 2px; font-size: 8pt"
                                href="{{ url('nova-actividade') }}">Criar Actividade</a></th>
                        <th>Inicio/Fim</th>
                ...
                <tbody class="table-border-bottom-0">
                    ...
                    @foreach ($actividades as $item)
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <a href="{{ url('/nova-actividade', $item->id) }}"><i
                                            class="bx bx-edit-alt me-1"></i> Edit / Alterar Estado</a>

                                    <a href="{{ url('/tarefas', $item->id) }}"><i class="bx bx-edit-alt me-1"></i>
                                        Tarefas</a>

                                    {{--    <a href="{{ url('/remover-atividade', $item->id) }}"><i
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="post" action="{{ url('remover_actividade') }}">
                                    @csrf
